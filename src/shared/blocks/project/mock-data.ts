...
export const mockCharacters: Character[] = [
  {
    ...
    description: '高中二年级学生，拥有敏锐的观察力和超凡的推理能力。性格开朗活泼，喜欢甜食。',
  },
  {
    id: 'char-002',
    name: '苏云',
    imageUrl: 'https://picsum.photos/seed/char2/400/400',
    description: '神秘的转学生，总是独来独往。似乎隐藏着不为人知的秘密，对小樱的调查表现出浓厚的兴趣。',
  },
  {
    id: 'char-003',
    name: '陈老师',
    imageUrl: 'https://picsum.photos/seed/char3/400/400',
    description: '班主任老师，表面严肃实则关心学生。年轻时曾是一名刑警，经常为小樱提供线索。',
  },
];
...
export const mockStoryboards: Storyboard[] = [
  {
    ...
    imagePrompt: 'A classroom scene with morning sunlight, a girl sitting by the window looking at cherry blossoms, anime style',
    videoUrl: '',
    videoPrompt: 'Camera slowly pans from the window to the classroom door as a teacher enters',
  },
  {
    id: 'sb-002',
    ...
    imagePrompt: 'A mysterious boy in black jacket standing at the classroom door, anime style, dramatic lighting',
    videoUrl: '',
    videoPrompt: 'The new student walks slowly into the classroom, all eyes on him',
  },
  {
    id: 'sb-003',
    ...
    imagePrompt: 'Two students making eye contact across the classroom, intense moment, shoujo manga style',
    videoUrl: '',
  ...
  },
  {
    ...
    imagePrompt: 'After school scene, boy standing under cherry blossom tree, soft evening light, anime style',
    videoUrl: '',
    videoPrompt: 'Sakura petals falling gently, camera focuses on the mysterious student',
  },
  {
    id: 'sb-005',
    ...
    imagePrompt: 'Two high school students facing each other under cherry blossoms, mysterious atmosphere',
    videoUrl: '',
    videoPrompt: 'Conversation scene with cherry blossoms in background, slight camera movement',
  },
  {
    id: 'sb-006',
    ...
    imagePrompt: 'Close-up of determined girl facing mysterious boy, tense atmosphere, anime style',
    videoUrl: '',

...
var prismatic_burst_1 = require("@/shared/components/magicui/prismatic-burst"); // Quotes with attributions in the style of the reference image


var LOADING_QUOTES = [{
  text: 'AI 是笔，创意是墨，故事永远由你书写。',
  author: 'AI-Manga'
}, {
  text: '从构思到成画，让创作的距离缩短为一个想法。',
  author: 'AI-Manga'
}, {
  text: '人人都可以是漫画家，只要心中有故事。',
  author: 'AI-Manga'
}, {
  text: '技术降低门槛，热爱决定高度。',
  author: 'AI-Manga'
...
function PageLoader() {
  var _a = react_1.useState('pending'),
      state = _a[0],
      setState = _a[1];
  ...
  react_1.useEffect(function () {
    ...
    var interval = setInterval(function () {
      setCurrentIndex(function (prev) {
        return (prev + 1) % LOADING_QUOTES.length;
      });
    }, TEXT_INTERVAL);
    return function () {
  ...
  return React.createElement(framer_motion_1.motion.div, {
  ...
  }, React.createElement(prismatic_burst_1.PrismaticBurst, {
    animationType: "rotate3d",
    intensity: 15,
    speed: 2,
    colors: ['#EBD4DC', '#D4DCF0', '#DADADE', '#E0D4EB', '#D4E8E2', '#F0E4D8'],
    paused: state === 'exiting',
    mixBlendMode: "normal"
  })), React.createElement("div", {
    className: "relative z-10 flex flex-col items-center justify-center px-6"
  }, React.createElement(framer_motion_1.AnimatePresence, {
    mode: "wait"
    ...
    className: "text-center text-lg font-medium tracking-wide text-gray-700 md:text-xl lg:text-2xl"
  }, currentQuote.text), React.createElement("p", {

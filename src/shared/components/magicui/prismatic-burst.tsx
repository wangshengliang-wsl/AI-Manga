...
interface PrismaticBurstProps extends Omit<ComponentPropsWithoutRef<'div'>, 'offset'> {
  intensity?: number;
  speed?: number;
...
export function PrismaticBurst({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // Explicitly release WebGL context for better GPU resource management
      ...
      try {
        ...
        // Canvas may already be removed from the DOM
      }
